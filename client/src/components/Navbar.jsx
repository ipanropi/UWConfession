...
const Navbar = () => {
    ...
    return (
        <>
            <div className="flex justify-center items-center sticky top-0 z-30 bg-[#fafafa] w-full h-20 border-b p-4 -mt-4">
                <div className="flex justify-between gap-4 w-full">
                    <Link to={"/"} className={styles("/")} onClick={() => scrollToTop("/")}>
                    ...
                    <div className="flex justify-center">
                        <Link to={"/newpost"} className={styles("/newpost")} onClick={() => scrollToTop("/newpost")}>
                            <h1>Add post</h1>
                        </Link>
                    </div>
                </div>
            ...
            <div id="banner" tabIndex="-1"
                 className="flex z-20 gap-8 justify-center items-center py-3 px-4 w-full bg-gray-50 sm:items-center lg:py-4 border-b border-gray-200">
                <p className="text-sm font-mono md:text-center">Don't know what to write? Check out our daily
                    prompts! <br/><br/>
